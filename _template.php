...
/*<![CDATA[*/
  ...
  <body id="s5_body">
    <div id="s5_scrolltotop"></div><!-- Top Vertex Calls -->
    <!-- Call top bar for mobile devices if layout is responsive --><!-- s5_responsive_mobile_top_bar_spacer must be called to keep a space at the top of the page since s5_responsive_mobile_top_bar_wrap is position absolute. -->
    <div id="s5_responsive_mobile_top_bar_spacer"></div><!-- s5_responsive_mobile_top_bar_wrap must be called off the page and not with display:none or it will cause issues with the togglers. -->
    <div id="s5_responsive_mobile_top_bar_wrap" style="margin-top:-50000px;position:absolute;z-index:20;top:0px">
      <div id="s5_responsive_mobile_top_bar" class="s5_responsive_mobile_bar_light">
        <div id="s5_responsive_mobile_toggle_click_menu" style="display:block;float:left"></div>
        <div id="s5_responsive_mobile_bar_active">
          <span><?php echo @$title; ?></span>
        </div>
        <div id="s5_responsive_mobile_toggle_click_login" style="display:none;float:right"></div>
        <div id="s5_responsive_mobile_toggle_click_register" style="display:none;float:right"></div>
        <div id="s5_responsive_mobile_toggle_click_search" style="display:block;float:right"></div>
      ...
      <div id="s5_responsive_modile_drop_down_wrap" class="s5_responsive_modile_drop_down_wrap_loading">
        <div id="s5_responsive_mobile_drop_down_menu">
          <div class="s5_responsive_mobile_drop_down_inner" style="-webkit-box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.6);-moz-box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.6);box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.6);">
            <ul class="menu">
              <li class="item-home<?= ($path == '/') ? ' current active' : '' ?>">
                <a href="/">Home</a>
              </li>
              <li class="item-bitcoin<?= ($path == '/bitcoin') ? ' current active' : '' ?>">
                <a href="/bitcoin">Bitcoin?</a>
              </li>
              <li class="item-why<?= ($path == '/why') ? ' current active' : '' ?>">
                <a href="/why">Why?</a>
              </li>
              <li class="item-how<?= ($path == '/how') ? ' current active' : '' ?>">
                <a href="/how">How?</a>
              </li>
              <li class="item-who<?= ($path == '/who') ? ' current active' : '' ?>">
                <a href="/who">Who?</a>
              </li>
              <li class="item-projects<?= ($path == '/projects') ? ' current active' : '' ?>">
...
//<![CDATA[
    ...
    <div id="s5_body_padding">
        ...
        <div id="s5_header_area_inner" class="s5_wrap">
          ...
          <div id="s5_menu_wrap">
            <ul id='s5_nav' class='menu'>
              ...
              <li<?= ($path == '/why') ? ' class="active"' : '' ?>>
                <span class='s5_level1_span1'><span class='s5_level1_span2'><a href="/why">Why?</a></span></span>
              </li>
              <li<?= ($path == '/how') ? ' class="active"' : '' ?>>
                <span class='s5_level1_span1'><span class='s5_level1_span2'><a href="/how">How?</a></span></span>
              </li>
              <li<?= ($path == '/who') ? ' class="active"' : '' ?>>
                <span class='s5_level1_span1'><span class='s5_level1_span2'><a href="/who">Who?</a></span></span>
              </li>
              <li<?= ($path == '/projects') ? ' class="active"' : '' ?>>
                <span class='s5_level1_span1'><span class='s5_level1_span2'><a href="/projects">Projects</a></span></span>
              </li>
            </ul>
          </div>
          <div style="clear:both; height:0px"></div>
      ...
      <div id="s5_header_area0"></div><!-- End Header --><!-- Top Row1 --><!-- End Top Row1 --><!-- Top Row2 --><!-- End Top Row2 -->
      <!-- Top Row3 --><!-- End Top Row3 --><!-- Center area -->
      <div id="s5_center_area1">
        <div id="s5_center_area2">
          <div id="s5_center_area_inner" class="s5_wrap">
            <!-- Above Columns Wrap --><!-- End Above Columns Wrap --><!-- Columns wrap, contains left, right and center columns -->
            <div id="s5_columns_wrap">
              <div id="s5_columns_wrap_inner">
                ...
                </div><!-- Left column --><!-- End Left column --><!-- Right column --><!-- End Right column -->
              </div>
            </div><!-- End columns wrap --><!-- Below Columns Wrap --><!-- End Below Columns Wrap -->
          </div>
        </div>
      </div><!-- End Center area --><!-- Bottom Row1 --><!-- End Bottom Row1 --><!-- Bottom Row2 --><!-- End Bottom Row2 -->
      <!-- Bottom Row3 --><!-- End Bottom Row3 -->
      <!-- Footer Area -->
      <div id="s5_footer_area1">
        <div id="s5_footer_area2">
          <div id="s5_footer_area_inner" class="s5_wrap">
            <div id="s5_footer"></div>
      ...
      <!-- Bottom Vertex Calls -->
      <!-- Page scroll, tooltips, multibox, and ie6 warning --><!-- Start compression if enabled -->
...
//<![CDATA[
      ...
      new Slidex(options);
      //]]>
      </script> <!-- File compression. Needs to be called last on this file --> <!-- Responsive Bottom Mobile Bar -->
       <!-- Call bottom bar for mobile devices if layout is responsive -->
      <div id="s5_responsive_mobile_bottom_bar_outer" style="display:none">
        <div id="s5_responsive_mobile_bottom_bar" class="s5_responsive_mobile_bar_light">
          <!-- Call mobile links if links are enabled and cookie is currently set to mobile -->
          <div id="s5_responsive_switch_mobile">
            <a id="s5_responsive_switch" href="/?s5_responsive_switch_cecgbiz=0" name="s5_responsive_switch">Desktop Version</a>
          </div>
      ...
      </div><!-- Call bottom bar for all devices if user has chosen to see desktop version -->
